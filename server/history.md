...
| :---------------------: | :----------------------------------------------------------: |
|           今            |                    お前がこのページを見る                    |
|       2020/11/02        |         カーネルパニックが発生する(約7時間後に復旧)          |
|       2020/11/01        | [X9Z](https://jaoafa.com/user/X9Z)(オムレツ)が一時的に運営業務から離脱する |
|       2020/10/27        | [公式Discordサーバ](https://wiki.jaoafa.com/jMS_Gamers_Club)の#generalに毎日0時に投稿される一日の情報に「きょうのにゃんこ」が追加される |
|       2020/10/23        |                ワールドデータの一部が破損する                |
|       2020/10/17        |   jMS公式Guildedサーバ(jMS Guilded Club)が作成・公開される   |
|       2020/10/08        | メンテナンスが実施される(CoreProtectの過去データを別データベースに移動・保管する作業) |
|       2020/10/05        | Default・Verified[権限](https://jaoafa.com/rule/management/permission)でも水・溶岩が使用できるようになる(爆新地内では拡散せず溜まり続ける) |
|       2020/09/28        | [公式Discordサーバ](https://wiki.jaoafa.com/jMS_Gamers_Club)にVCSpeakerが再設置される(#vcに投稿されたメッセージの読み上げなど) |
|       2020/09/09        | [公式Discordサーバ方針](https://jaoafa.com/rule/management/discord)が更新され、[Discordサーバ](https://wiki.jaoafa.com/jMS_Gamers_Club)内に@SubAccount権限が新設される |
|       2020/08/30        | [イオソモールを紹介した動画](https://www.nicovideo.jp/watch/sm37349215)が[ニコニコニュース](https://originalnews.nico/272119)に取り上げられる |
|       2020/08/20        | [jaopedia](https://wiki.jaoafa.com/)の利用者整理が実施される |
|       2020/08/12        | [jMS Gamers Club](https://wiki.jaoafa.com/jMS_Gamers_Club)がコミュティサーバになる |
|       2020/08/01        |     匿名で運営に質問できる、「QuestionBox」が開設される      |
|       2020/08/01        | [2020年夏サバイバルイベント](https://jaoafa.com/blog/tomachi/202008event_summer2020)が開始される |
|       2020/07/29        | 「VoteNotify」(指定した時刻に投票してなければ通知する機能)が作成・導入される |
|       2020/07/19        | [clubjaoafa](https://jaoafa.com/rule/management/clubjaoafa)からの[自治体申請](https://jaoafa.com/rule/management/cities)処理において5点以上のコーナーがある自治体の処理を行えるようになる |
|       2020/07/05        | monocraft.netからの[投票](https://jaoafa.com/server/vote)によって、AFK時に表示されるパーティクルが投票数によって解放され、自由に選べるようになる |
|       2020/06/24        | [monocraft.netに登録](https://jaoafa.com/blog/tomachi/registered_monocraft)する |
|       2020/06/15        | [新型コロナウイルス(COVID-19)への対応](https://jaoafa.com/blog/tomachi/202003_covid-19)(Ver.1.12.2以外でのログイン許可)を終了する |
|       2020/06/13        | [大規模メンテナンス](https://jaoafa.com/blog/tomachi/202006_maintenance)が実施される |
|       2020/05/30        | [公式Discordサーバ](https://wiki.jaoafa.com/jMS_Gamers_Club)にて利用者整理が実施される |
|       2020/05/22        | 「[開発部リクエストボックス](https://forms.gle/Vf13Ubfa68WcW1er9)」が開設される |
|       2020/05/21        | [自治体申請](https://jaoafa.com/blog/tomachi/new_cityrequest_method)がclub.jaoafa.comから行えるようになる |
|       2020/04/09        |                  jao Minecraft Server 4周年                  |
|       2020/04/08        | 今までGoogle Driveで管理してきた自治体情報を、[データベース管理](https://jaoafa.com/cities/)に切り替える |
