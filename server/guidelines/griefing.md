...
必要以上に煽ったりせず、適切な方法で運営に報告し、放置してください。  
迷惑行為を行うプレイヤーは、相手の困ったリアクション、怒ったリアクションを求めています。ですので、「やめてください」などといったような反応はせずに、報告だけ行って無視をキメるようにしましょう。

## 迷惑行為を見つけた場合

### 無断改造・破壊行為

自分で修復等をせず、プライベートチャット(`/tell`等)や[公式Discordサーバ](/blog/join-discord)の`#support`などを用いて、運営に「荒らされたこと」と「荒らされている座標」を報告してください。
