...
- サービスの運営に伴い、イベントを実施します。詳細については、公式Discordサーバ内にて告知します。
...
jao Minecraft Serverは開設以来、多くの利用者様にログイン頂いていました。しかし近年は、「週末や休日でも、1日を通してログインする人が1人もいない」という状況でした。  
これに対して、「誰もサーバ」という意見が、運営チーム内であがっていました。
